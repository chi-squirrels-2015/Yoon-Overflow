class AddCachedVotesToQuestions < ActiveRecord::Migration
  def self.up
    ...
    add_column :questions, :cached_weighted_average, :float, :default => 0.0
  ...
  def self.down
    ...
    remove_column :questions, :cached_weighted_total
    remove_column :questions, :cached_weighted_average
  end
end
